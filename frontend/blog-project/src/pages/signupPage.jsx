    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100 p-6">
      <div className="bg-white p-8 rounded-2xl shadow-2xl w-full max-w-lg">
        ...
        <div className="text-center mt-6 mb-8">
          ...
          <p className="text-lg text-gray-600 mt-2">Sign up to join our community!</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              placeholder="John"
              className={`w-full p-3 rounded-lg border-2 ${errors.firstName ? 'border-red-500' : 'border-gray-300'} focus:outline-none focus:border-blue-500 transition-colors`}
            />
          ...
          <div>
            ...
            <input
              ...
              onChange={handleChange}
              placeholder="Doe"
              className={`w-full p-3 rounded-lg border-2 ${errors.lastName ? 'border-red-500' : 'border-gray-300'} focus:outline-none focus:border-blue-500 transition-colors`}
            />
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                onChange={handleChange}
                placeholder="Password"
                className={`w-full p-3 rounded-lg border-2 ${errors.confirmPassword ? 'border-red-500' : 'border-gray-300'} focus:outline-none focus:border-blue-500 transition-colors`}
              />
              <button
                type="button"
            ...
            <p className="text-sm text-gray-500 mt-1">Should be similar password</p>
          </div>
